package com.example.dermalyze.ui.main.data
...
object ArticlesData {
    ...
    val dummyArticles = listOf(
        Article(
            id = 1,
            title = "Kurap",
            content = "Kurap adalah infeksi jamur pada kulit yang menimbulkan ruam melingkar berwarna merah. Kurap dapat terjadi di beberapa area tubuh, seperti kepala, wajah, tangan, kaki, atau selangkangan.\n" +
                    "\n" +
                    ...
                    "alodokter-kurap\n" +
                    "\n" +
                    "Karena bentuknya seperti cincin atau cacing yang melingkar, kurap juga dikenal dengan sebutan ringworm. Sebutan lain untuk kondisi ini adalah kadas.\n" +
                    "\n" +
            ...
            publisher = "Ditinjau oleh: dr. Pittara",
            datePublish = "Terakhir diperbarui: 13 April 2022",
            imageUrl = "https://asset.kompas.com/crops/87rSxjZQAwyhXVazyxD-t3fcwoA=/0x0:600x400/750x500/data/photo/2023/03/11/640c656ea8fb2.png"
        ),
        Article(
            id = 2,
            title = "Vitiligo",
            content = "Vitiligo adalah penyakit yang menyebabkan warna kulit memudar. Area kulit yang memudar biasanya bertambah besar seiring waktu. Selain bisa menyerang area kulit mana pun di tubuh, vitiligo juga dapat terjadi di bagian dalam mulut, mata, rambut, dan area kelamin.\n" +
                    "\n" +
                    ...
                    "Segera temui dokter bila warna rambut, kulit, mata, atau bagian dalam mulut Anda memudar. Meski vitiligo tidak bisa diobati, tetapi penanganan yang tepat sejak dini dapat menghambat perkembangan penyakit ini.\n" +
                    "\n" +
                    "Diagnosis Vitiligo\n" +
                    ...
                    "\n" +
                    "Pengobatan Vitiligo\n" +
                    "Vitiligo tidak bisa disembuhkan. Namun, dokter dapat memberikan tindakan medis untuk memperlambat atau menghentikan perubahan warna kulit. Penanganan vitiligo juga bertujuan untuk menyeragamkan warna bercak vitiligo dengan warna kulit di sekitarnya semaksimal mungkin.\n" +
                    "\n" +
                    "Penanganan vitiligo tergantung pada usia pasien, seberapa luas area yang terkena vitiligo, seberapa cepat penyebarannya, dan pengaruh vitiligo terhadap kualitas hidup pasien.\n" +
                    "\n" +
                    "Untuk perawatan awal, dokter akan menganjurkan pasien untuk terlebih dahulu menggunakan tanning lotion atau losion penggelap kulit. Dokter juga akan menyarankan pasien memakai tabir surya dengan SPF 30 atau lebih untuk mencegah kerusakan kulit yang lebih parah akibat paparan sinar matahari.\n" +
                    "\n" +
                    "Namun, jika cara di atas tidak efektif, dokter akan menyarankan metode lain, seperti:\n" +
                    "\n" +
                    "1. Obat-obatan\n" +
                    "Meski belum ada obat yang dapat menghentikan perkembangan vitiligo, beberapa obat berikut ini dapat mengembalikan warna kulit normal pasien:\n" +
                    "\n" +
                    "Kortikosteroid oles\n" +
                    "\n" +
                    ...
                    "\n" +
                    "Perlu diketahui bahwa kortikosteroid tidak boleh digunakan pada ibu hamil atau pasien dengan vitiligo di wajah. Selain itu, penggunaan jangka panjang juga dapat menimbulkan efek samping berupa penipisan lapisan kulit dan munculnya stretch mark.\n" +
                    "\n" +
                    "Tacrolimus\n" +
                    "\n" +
                    "Pada vitiligo yang hanya terjadi di area kecil, seperti di wajah atau selangkangan, dokter akan meresepkan salep yang mengandung tacrolimus. Namun, salep ini tidak umum digunakan untuk mengobati vitiligo, karena dapat menyebabkan efek samping berupa penipisan kulit.\n" +
                    "\n" +
                    "Hydroquinone\n" +
                    "\n" +
                    "Pada pasien dengan vitiligo yang sudah meluas hampir di seluruh tubuh, dokter akan meresepkan losion dengan kandungan hydroquinone. Losion akan dioleskan ke kulit normal, agar warnanya menjadi serupa dengan bercak vitiligo.\n" +
                    "\n" +
                    "2. Terapi sinar UV\n" +
                    "Terapi sinar UV (fototerapi) dilakukan bila vitiligo telah menyebar luas dan tidak bisa ditangani oleh obat oles. Fototerapi dilakukan dengan memaparkan sinar ultraviolet A (UVA) atau B (UVB) ke area kulit yang terkena vitiligo.\n" +
                    "\n" +
                    "Sebelum fototerapi, kulit pasien akan diberikan obat golongan psoralen, seperti methoxsalen agar lebih sensitif pada sinar UV. Pasien setidaknya membutuhkan 2–3 kali terapi dalam 1 minggu, selama 6 sampai 12 bulan.\n" +
                    "\n" +
                    "3. Prosedur bedah\n" +
                    "Prosedur bedah dilakukan bila fototerapi tidak efektif pada pasien. Tujuan bedah adalah untuk mengembalikan warna yang normal pada kulit yang terkena vitiligo.\n" +
                    "\n" +
                    "Sejumlah metode bedah untuk menangani vitiligo adalah:\n" +
                    "\n" +
                    "Cangkok kulit\n" +
                    "\n" +
                    "Cangkok kulit dilakukan apabila vitiligo hanya menyerang sebagian kecil area tubuh. Pada prosedur ini, dokter akan mengambil kulit yang sehat untuk melapisi kulit yang terkena vitiligo.\n" +
                    "\n" +
                    "Cangkok kulit dilakukan pada vitiligo yang tidak melebar dalam 1 tahun terakhir dan pada vitiligo yang tidak dipicu oleh luka bakar akibat paparan sinar matahari. Akan tetapi, metode ini tidak dianjurkan untuk anak-anak.\n" +
                    "\n" +
                    "Blister grafting\n" +
                    "\n" +
                    "Sama seperti cangkok kulit, blister grafting dilakukan dengan mengambil kulit yang sehat untuk melapisi kulit yang terkena vitiligo. Bedanya, kulit yang diambil akan dilepuhkan terlebih dahulu, kemudian bagian atas lepuhan akan dibuang sebelum dicangkokkan.\n" +
                    "\n" +
                    "Mikropigmentasi\n" +
                    "\n" +
                    "Mikropigmentasi dilakukan dengan menanam pigmen ke kulit yang terkena vitiligo. Prosedur ini paling efektif untuk menangani vitiligo di bibir. Mikropigmentasi perlu diulang tiap beberapa tahun agar warna kulit yang normal dapat dipertahankan.\n" +
                    "\n" +
                    "Perlu diketahui, butuh waktu berbulan-bulan agar penanganan vitiligo menunjukkan hasil yang efektif. Namun, hasilnya akan sangat beragam pada tiap pasien. Oleh sebab itu, konsultasikan dengan dokter mengenai metode penanganan yang tepat.\n" +
                    "\n" +
                    "Komplikasi Vitiligo\n" +
                    "Vitiligo yang tidak ditangani dapat terus berkembang dan mengakibatkan beberapa komplikasi berikut ini:\n" +
                    "\n" +
                    "Stres, cemas, atau depresi\n" +
                    "Peradangan pada iris mata (iritis)\n" +
                    "Kulit mudah terbakar sinar matahari\n" +
                    "Hilang pendengaran sebagian\n" +
                    "Penyakit autoimun seperti penyakit Addison, hipertiroidisme, atau lupus\n" +
                    "Kanker kulit\n" +
                    "Pencegahan Vitiligo\n" +
                    "Seperti telah disebutkan di atas, penyebab vitiligo belum diketahui secara pasti. Oleh sebab itu, belum ada cara untuk mencegah penyakit ini. Namun, ada beberapa hal yang dapat diterapkan untuk mengurangi risiko terkena penyakit ini, yaitu:\n" +
                    "\n" +
                    "Memakai tabir surya, terutama saat beraktivitas di luar ruangan pada siang hari\n" +
                    "Menggunakan pelindung diri, seperti payung atau topi, serta mengenakan pakaian yang tertutup untuk menghindari paparan sinar matahari\n" +
            ...
            publisher = "Ditinjau oleh: dr. Pittara",
            datePublish = "Terakhir diperbarui: 24 Februari 2024",
            imageUrl = "https://res.cloudinary.com/dk0z4ums3/image/upload/v1589166576/attached_image/vitiligo-0-alodokter.jpg"
        ),
        Article(
            id = 3,
            title = "Jerawat",
            content = "Jerawat adalah masalah kulit yang terjadi ketika pori-pori kulit, tepatnya folikel rambut, tersumbat oleh kotoran, debu, minyak, atau sel kulit mati. Akibatnya, terjadi peradangan pada pori-pori tersebut dan bisa juga disertai infeksi. Jerawat sering muncul di wajah, leher, punggung, atau dada.\n" +
                    "\n" +
            ...
            publisher = "Ditinjau oleh: dr. Pittara",
            datePublish = "Terakhir diperbarui: 26 April 2024",
            imageUrl = "https://res.cloudinary.com/dk0z4ums3/image/upload/v1655092166/attached_image/jerawat-0-alodokter.jpg"
        ),
        Article(
            id = 4,
            title = "Herpes Bibir",
            content = "Herpes bibir adalah penyakit infeksi pada bibir yang disebabkan oleh virus herpes simpleks tipe 1 (HSV-1). Penyakit ini ditandai dengan luka lepuh di bibir. Herpes bibir umumnya menular melalui ciuman atau berbagi alat makan.\n" +
                    "\n" +
            ...
            publisher = "Ditinjau oleh: dr. Pittara",
            datePublish = "Terakhir diperbarui: 28 Oktober 2022",
            imageUrl = "https://res.cloudinary.com/dk0z4ums3/image/upload/v1666934724/attached_image/herpes-bibir-0-alodokter.jpg"
        ),
        Article(
            id = 5,
            title = "Jerawat Batu",
            content = "Jerawat batu adalah bentuk jerawat yang paling parah. Jerawat ini memiliki ukuran yang lebih besar, kemerahan, berisi nanah, dan menimbulkan nyeri. Jerawat jenis ini memerlukan penanganan oleh dokter.\n" +
                    "\n" +
                    "Jerawat batu atau disebut juga sebagai jerawat kistik (cystic acne). Jerawat batu terbentuk ketika bakteri menginfeksi kulit lebih dalam sehingga menimbulkan kondisi yang lebih parah dari jerawat biasa. Jika tidak ditangani dengan tepat, jerawat batu dapat menyebar ke kulit di sekitarnya dan biasanya meninggalkan bekas luka jerawat.\n" +
                    "\n" +
                    "Jerawat Batu - Alodokter\n" +
                    "\n" +
                    "Jerawat kistik sering kali disamakan dengan jerawat nodul, padahal bentuk keduanya berbeda. Jerawat nodul memiliki tekstur lebih keras karena tidak berisi cairan, sedangkan jerawat batu teraba lebih lunak karena berisi nanah. Akan tetapi, keduanya sama-sama memerlukan penanganan dokter.\n" +
                    "\n" +
                    ...
                    "\n" +
                    "Terbentuknya jerawat batu dipengaruhi oleh banyaknya produksi minyak oleh kelenjar sebasea yang diatur oleh hormon androgen. Hormon ini menjadi lebih aktif ketika memasuki masa pubertas. Selain itu, ada beberapa faktor yang dapat memengaruhi kerja hormon androgen, yaitu:\n" +
                    "\n" +
                    "Siklus menstruasi\n" +
                    "Kehamilan\n" +
                    "Menopause\n" +
                    "Polycystic ovary syndrome (PCOS)\n" +
                    "Konsumsi obat-obat tertentu, seperti kortikosteroid, lithium, atau obat antikejang\n" +
                    "Selain karena faktor-faktor yang memengaruhi hormon androgen, jerawat kistik lebih mudah muncul akibat kondisi berikut:\n" +
                    "\n" +
                    "Kulit berminyak\n" +
                    "Kebiasaan mengenakan pakaian yang terlalu ketat\n" +
                    "Penggunaan produk perawatan kulit yang komedogenik\n" +
                    "Cuaca yang sangat lembap\n" +
                    "Kurang menjaga kebersihan tubuh\n" +
                    "Stres berat\n" +
                    "Meski dapat dialami oleh siapa saja, jerawat batu lebih rentan terjadi pada usia remaja dan awal 20 tahun. Selain itu, jerawat batu juga lebih rentan dialami oleh orang yang memiliki riwayat jerawat batu dalam keluarganya.\n" +
                    "\n" +
                    "Gejala Jerawat Batu\n" +
                    "Jerawat batu memiliki bentuk yang serupa dengan bisul, tetapi kedua kondisi tersebut berbeda. Berikut ini adalah beberapa karakteristik jerawat batu:\n" +
                    "\n" +
                    "Bentol berukuran lebih besar dari jerawat biasa (sekitar 5 mm), berwarna kemerahan, dan berisi nanah\n" +
                    "Kemerahan pada area kulit di sekitarnya\n" +
                    "Bentol terasa sakit ketika disentuh\n" +
                    "Jerawat batu lebih sering muncul di area wajah dan hidung. Namun, jerawat batu juga bisa muncul di rahang, dada, leher, punggung, bahu, hingga belakang telinga.\n" +
                    "\n" +
                    "Kapan harus ke dokter\n" +
                    "Lakukan pemeriksaan ke dokter jika Anda memiliki jerawat berukuran besar yang disertai nyeri dan ciri-ciri yang telah disebutkan di atas. Anda juga perlu segera ke dokter jika jerawat kistik disertai tanda-tanda komplikasi, seperti nyeri yang tidak tertahankan dan demam.\n" +
                    "\n" +
                    "Perlu diketahui bahwa jerawat batu sangat sulit sembuh hanya dengan penanganan mandiri. Oleh karena itu, jerawat batu perlu mendapatkan penanganan medis dari dokter. Penanganan dokter juga perlu dilakukan untuk mencegah jerawat batu makin parah dan kambuh.\n" +
                    "\n" +
                    "Diagnosis Jerawat Batu\n" +
                    "Diagnosis jerawat batu akan diawali dengan tanya jawab mengenai riwayat timbulnya jerawat batu, riwayat penggunaan obat-obatan, serta riwayat kesehatan pasien dan keluarganya. Pada pasien wanita, dokter akan menanyakan siklus menstruasi untuk mengetahui apakah jerawat batu timbul akibat perubahan hormon.\n" +
                    "\n" +
                    "Setelah itu, dokter akan melakukan pemeriksaan di kulit, terutama pada area kulit yang mengalami jerawat batu, dengan menggunakan kaca pembesar. Umumnya, diagnosis sudah bisa ditegakkan melalui pemeriksaan fisik tersebut.\n" +
                    "\n" +
                    "Pengobatan Jerawat Batu\n" +
                    "Pengobatan jerawat batu bertujuan untuk menghilangkan jerawat dan meminimalkan bekas jerawat. Pengobatan tersebut dilakukan oleh dokter dan dikombinasikan dengan penanganan mandiri. Berikut ini adalah beberapa cara pengobatan jerawat kista.\n" +
                    "\n" +
                    "Penanganan oleh dokter\n" +
                    "Jerawat batu umumnya tidak bisa diatasi hanya dengan mengonsumsi obat yang dijual bebas. Oleh karena itu, dokter dapat meresepkan beberapa obat minum, yaitu:\n" +
                    "\n" +
                    "Antibiotik, untuk mengatasi infeksi bakteri dan mengurangi peradangan, yang diberikan kepada pasien yang memiliki jerawat kistik di banyak area\n" +
                    "Kortikosteroid, untuk mengurangi peradangan\n" +
                    "Retinoid tablet, seperti isotretinoin, untuk mengurangi produksi minyak berlebih pada kulit, yang biasanya diminum dua kali sehari selama 15–20 minggu\n" +
                    "Pil KB atau spironolactone, untuk mengontrol hormon\n" +
                    "Suntikan kortikosteroid, untuk mengurangi peradangan dan mengempiskan jerawat, yang langsung disuntikkan ke jerawat batu\n" +
                    "Dokter juga dapat memberikan obat-obatan dalam bentuk oles, seperti:\n" +
                    "\n" +
                    "Asam salisilat, untuk membunuh bakteri dan menghilangkan sel kulit mati\n" +
                    "Nicotinamide, untuk mengurangi peradangan\n" +
                    "Krim antibiotik, untuk membunuh bakteri di kulit\n" +
                    "Benzoyl peroxide, untuk mengurangi pertumbuhan bakteri di kulit\n" +
                    "Isotretinoin oles, untuk membantu meluruhkan sel kulit mati sehingga pori-pori kulit menjadi lebih bersih\n" +
                    "Jika diperlukan, dokter dapat melakukan operasi kecil untuk membuka jerawat batu dan mengeluarkan nanah yang terdapat di dalamnya.\n" +
                    "\n" +
                    "Penting untuk diketahui, bahwa obat-obat jerawat tersebut tidak boleh dikonsumsi oleh ibu hamil karena dapat meningkatkan risiko cacat pada janin.\n" +
                    "\n" +
                    "Setelah jerawat batu sembuh, dokter juga akan menganjurkan pasien untuk menjalani beberapa pengobatan untuk menghilangkan bekas jerawat, yaitu:\n" +
                    "\n" +
                    "Chemical peeling\n" +
                    "Dermabrasi\n" +
                    "Laser resurfacing\n" +
                    "Perawatan mandiri di rumah\n" +
                    "Untuk mempercepat proses penyembuhan, pasien akan dianjurkan untuk melakukan perawatan mandiri berikut:\n" +
                    "\n" +
                    "Cuci muka dua kali sehari atau setelah berkeringat, dengan menggunakan sabun pembersih wajah yang sesuai dengan jenis kulit. Namun, hindari mencuci muka terlalu sering.\n" +
                    "Jangan menggunakan scrub atau produk kulit yang dapat menyebabkan iritasi.\n" +
                    "Hindari menggunakan spons ketika membersihkan wajah.\n" +
                    "Jangan memencet dan memecahkan jerawat batu.\n" +
                    "Hindari paparan matahari dalam jangka panjang.\n" +
                    "Gunakan tabir surya atau sun screen yang nonkomedogenik setiap hari, terutama jika akan keluar rumah, karena obat jerawat dapat membuat kulit lebih sensitif terhadap sinar ultraviolet.\n" +
                    "Kelola stres dengan baik.\n" +
                    "Istirahat yang cukup.\n" +
                    "Lakukan olahraga secara rutin.\n" +
                    "Kurangi konsumsi makanan manis dan berminyak.\n" +
                    "Komplikasi Jerawat Batu\n" +
                    "Jerawat batu yang pecah dapat menimbulkan komplikasi pada kulit, seperti:\n" +
                    "\n" +
                    "Selulitis, yaitu infeksi bakteri pada kulit dan jaringan di bawahnya\n" +
                    "Bekas jerawat atau bopeng\n" +
                    "Perubahan warna pada kulit yang terkena jerawat batu\n" +
                    "Selain komplikasi di atas, penderita juga dapat merasa malu akibat timbulnya jerawat kistik. Penderita juga dapat menarik diri dari lingkungan sosial karena kurangnya rasa percaya diri. Jika dibiarkan, kondisi tersebut dapat menyebabkan penderitanya mengalami gangguan kecemasan atau depresi.\n" +
                    "\n" +
                    "Pencegahan Jerawat Batu\n" +
                    "Pencegahan jerawat batu dapat dilakukan dengan beberapa upaya berikut:\n" +
                    "\n" +
                    ...
                    "Gunakan produk skincare atau kosmetik yang mengandung bahan nonkomedogenik.\n" +
                    "Hindari menyentuh muka sebelum mencuci tangan.\n" +
                    "Konsumsilah makanan yang sehat dengan gizi yang lengkap dan seimbang, serta perbanyak asupan sayuran dan buah-buahan.\n" +
                    "Batasi konsumsi makanan manis dan berminyak.\n" +
                    "Lakukan keramas secara rutin, karena rambut yang kotor dapat menimbulkan jerawat.\n" +
                    "Minum air putih yang cukup.\n" +
                    "Kelola stres dengan baik dan cukup tidur.\n" +
                    "Hindari terlalu sering mengenakan pakaian yang terlalu ketat, apalagi ketika cuaca panas.\n" +
                    "Ganti sprei dan sarung bantal secara rutin.\n" +
                    "Jika timbul jerawat, konsultasikan terlebih dahulu dengan dokter sebelum melakukan pengobatan jerawat secara mandiri.",
            publisher = "Ditinjau oleh: dr. Pittara",
            datePublish = "Terakhir diperbarui: 24 Februari 2024",
            imageUrl = "https://res.cloudinary.com/dk0z4ums3/image/upload/v1673296755/attached_image/jerawat-batu-0-alodokter.jpg"
        )
